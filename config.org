...
#+begin_src emacs-lisp
    ;; Program Launchers
    (nate/leader-keys
      "r" '(:ignore t :which-key "Launchers")
      "rv" '(vterm-other-window :which-key "open vterm-other-window")
      "rd" '(dired :which-key "open dired")
      "rr" '(ranger :which-key "open ranger")
      "re" '(eww :which-key "open eww"))
#+end_src
